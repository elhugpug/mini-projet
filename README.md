...
```
Après avoir transformer le tableau de sortie pour le rendre exploitable, on peut créer les graphiques ![(voir le code détaillé)](graphique_ensemble.R) (code : graphique_ensemble) .
